...
public class Demo {
    public static void main(String[] args) {
        Book [] books = {new Book(1, "Java Basics"),
                new Book(2, "Java Advanced"),
                new Book(3, "Spring Basics")};

        Laptop [] laptops = {new Laptop(100, "HP"),
                new Laptop(200, "Dell"),
                new Laptop(300, "Apple")};
        ...
        Object output5 = (Laptop) findObject(laptops, bookToFind);
