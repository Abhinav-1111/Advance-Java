...
public class Demo {
    public static void main(String[] args) {
        ...
        System.out.println("Add elements to deque (Specifically at tail)");
        deque.addLast("Go");
        ...
        System.out.println("Add elements to deque (Specifically at head)");
        ...
        System.out.println("Fetch element from deque (always from tail)");
        System.out.println("Element at head is : " + deque.getLast());
        System.out.println("Element at head is : " + deque.peekLast());
